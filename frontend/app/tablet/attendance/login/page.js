...
export default function TabletAttendanceLoginPage() {
  ...
  useEffect(() => {
    ...
    const initScanner = async () => {
      ...
      const element = document.getElementById('qr-reader-attendance-login')
      if (!element || !isMounted) return

      try {
        const { Html5Qrcode } = await import('html5-qrcode')

        html5QrCode = new Html5Qrcode('qr-reader-attendance-login')
        ...
        <div className="max-w-md mx-auto py-16 px-4">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-2 mt-6">
              ...
              <h1 className="text-2xl font-bold">入退館メニュー</h1>
            </div>
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full flex items-center gap-4 p-6 bg-emerald-600 hover:bg-emerald-700 rounded-2xl text-white transition-all"
            >
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      <div className="max-w-md mx-auto py-16 px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 mt-2">入退館メニュー</p>
        </div>
        ...
        <div className="bg-white/10 rounded-2xl p-8">
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 pr-12"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            <button
              ...
              className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isLoggingIn ? (
                <>
